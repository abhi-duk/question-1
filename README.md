...
Here I tried to make the app a heavy data handling page that uses various React features to optimize, secure, and load gracefully. 


I have hosted this in Vercel, and the live URL is: question-1-abhi-cdipd.vercel.app
